...
void kalmanCalc::calcMatrixMulit_KP(const dType Kx, const dType Kv,
...
dType kalmanCalc::calcR(locationCoor v_t, locationCoor v_t_1, dType reliability) {
    dType ans = 0.0f;
    dType k = 0.0f;
...
dType kalmanCalc::calcR(dType reliability) {
    dType ans = 0.0f;
    if (reliability < 2.5f) {
        ans = 0.05;
...
dType kalmanCalc::calcR(locationCoor v_t, locationCoor v_t_1) {
    dType v_mod_square = calcDistanceSquare(v_t, v_t_1);
...
dType kalmanCalc::calcR(QPoint v_t, QPoint v_t_1) {
